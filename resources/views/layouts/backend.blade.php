...
<html lang="{{ config('app.locale') }}">
    <head>
        ...
        <!-- Icons -->
        <link rel="shortcut icon" href="{{ asset('front/theme-luiza/images/placeholders/logo.png') }}">
        <link rel="icon" sizes="192x192" type="image/png" href="{{ asset('front/theme-luiza/images/placeholders/logo.png') }}">
