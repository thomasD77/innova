            ...
            <div class="col-md-8 col-lg-6 col-xl-4">
                ...
                <div class="block block-rounded mb-0">
                    <div class="block-header block-header-default">
                        <h3 class="block-title">Create Client Account</h3>
                    ...
                    <div class="block-content">
                        <div class="p-sm-3 px-lg-4 px-xxl-5 py-lg-5">
                            ...
                            <p class="fw-medium text-muted">
                                Please fill the following details to create a new Client account.
                            </p>
...
{{--                                     Hidden ID to register as Client--}}
                                    <div class="mb-4">
                                        <input type="hidden" class="form-control form-control-lg form-control-alt" name="client" value="1">
                                    </div>
                                </div>
                                <div class="row mb-4">
    ...
    <div class="modal fade" id="one-signup-terms" tabindex="-1" role="dialog" aria-labelledby="one-signup-terms" aria-hidden="true">
        <div class="modal-dialog <?php require '../resources/inc/_global/config.php'; ?>
        <?php require '../resources/inc/_global/views/head_start.php'; ?>
        <?php require '../resources/inc/_global/views/head_end.php'; ?>
        <?php require '../resources/inc/_global/views/page_start.php'; ?>
